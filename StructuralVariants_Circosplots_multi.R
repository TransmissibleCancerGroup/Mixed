...
## Set of multi-output: 4 Tumours, 4 Hosts
SVs <- read.table("/Users/ms37/Desktop/Labwork/2016/08_August/23_08_BRASS_all/All_samples_multi_small.rearr",sep = '\t', header=F)
SVs <- SVs[,c(1,3,4,5,7,8,2,6,9:16)]
